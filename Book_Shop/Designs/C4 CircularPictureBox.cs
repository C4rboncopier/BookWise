...
namespace Book_Shop
{
    internal class C4_CircularPictureBox : PictureBox
    {
        // Fields
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            using (var penSmooth = new Pen(this.BackColor, smoothSize)) // Use the PictureBox background color
